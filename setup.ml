...
(* OASIS_START *)
(* DO NOT EDIT (digest: d7e4c0af840fc6d3e733072ec6e9942f) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$ounit_test", []))];
     ...
     package =
       {
          ...
          version = "0.1";
          license = OASISLicense.OtherLicense "gopher://license.to.kill";
          ...
          authors = ["none"];
          homepage = Some "https://github.com/cfcs/ocaml-socks";
          bugreports = None;
          synopsis = "SOCKS proxy";
          description =
            Some
              [OASISText.Para "SOCKS4a library for ocaml clients and servers"
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               SrcRepo
                 ({
                  ...
                  },
                   {
                      ...
                      src_repo_browser =
                        Some "https://github.com/cfcs/ocaml-socks";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("rresult", None)];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Socks4_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "socks";
                      lib_findlib_name = None;
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\177\251\250\225\220\149\144\226f\204\012:};@\246";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
